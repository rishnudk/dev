...
export default function PortfolioCard({ portfolio, index, showDelete, onDeleted }: Props) {
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {showDelete && (
                                    <button
                                        ...
                                        disabled={deleting}
                                        className="absolute top-3 right-3 bg-red-600/80 hover:bg-red-600
               backdrop-blur-sm text-white text-xs px-3 py-1.5
               rounded-lg transition-colors z-10 disabled:opacity-50"
                                    >
                                        {deleting ? '...' : '🗑️ Delete'}
                                    </button>
                                )}
